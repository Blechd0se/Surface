...
$varivariable_login = htmlspecialchars($params->get('moduleclass_sfx'));
// Sehr umständliche if-Abfrage, aber funktioniert:

if ($varivariable_login != null) : ?>
	<?php if ($type == 'logout') : ?>
    ...
    <div id="topnav" class="topnav"><a href="#" class="signin"><?php echo $module->title; ?><div class="smallarrow-bottom"></div></a></div>
    <form action="<?php echo JRoute::_('index.php', true, $params->get('usesecure')); ?>" method="post" id="signin" >
        ...
        <?php endif; ?>
        <br>
        <input type="submit" name="Submit" class="signin_submit" value="<?php echo JText::_('JLOGIN') ?>" />
        <input type="hidden" name="option" value="com_users" />
    ...
    <script type="text/javascript">
            $(document).ready(function() {	
				...
				function() {
					$("fieldset#signin_menu").hover(
						function() {
						$("fieldset#signin_menu").show();
						},
						// Spezielles Skript für das Login-Modul
						function() {
